var Weglot = function() {
            ...
            if (i && o.isConnected) {
                for (var l = 0, s = i; l < s.length; l += 1) {
                    var u = s[l]
                      ...
                      , g = u.translations
                      , p = g[t] || c;
                    (t === a.language_from || g[t] && c !== g[t]) && (f && (o.weglot.setted = !0,
                    q(o, p, f, c, e)),
                    d && (o.weglot.setted = !0,
                    d(o, p, c)))
                }
    ...
    Q.set = function(e) {
        ...
        if (Z && t) {
            ...
            var f = r ? ";domain=" + r : ""
              ...
              , g = ";path=/" + (a || "")
              , p = i ? ";Partitioned" : "";
            document.cookie = t + "=" + n + f + g + d + p + ";SameSite=None;Secure"
        }
    }
    ,
    Q.get = function(e) {
    ...
    function Ve() {
        ...
        var l = null
          ...
          , u = t.find((function(t) {
            ...
            if (d)
                return l = d.custom_code || d.language_to,
                !0;
            if (i) {
        ...
        return Ge.convertLocale = function(t, n, r, o) {
            ...
            var w = $e((t === a ? c : f).replace(/CODE/g, t))
              , b = g.replace(s, w);
    ...
    function mt(e) {
        ...
        n = "/account",
        (Eo.is_connect && t !== Eo.language_from ? dt[n] ? dt[n] : (ot((function(e) {
        ...
        return A(e).filter((function(e) {
            ...
            return function(t) {
                ...
                if (i) {
                    ...
                    f ? Object.assign(f, d) : l.content.push(d)
                }
                return n
            }
        }(n))
    ...
    function an(e, t) {
        ...
        for (var i = [], l = {}, s = 0, u = e; s < u.length; s += 1)
            for (var c = u[s], f = c.weglot, d = c.translationLabel, g = 0, p = f.content; g < p.length; g += 1) {
                var v = p[g]
                  , _ = v.original
                  , h = v.type;
                l[_] || (n && Qt(_) || (l[_] = !0,
                i.push(Object.assign({}, {
                    ...
                    l: [t.label, d].filter(Boolean).map((function(e) {
            ...
            for (var r = e.from_words, a = e.to_words, o = 0, i = n; o < i.length; o += 1)
                for (var l = 0, s = i[o].weglot.content || {}; l < s.length; l += 1) {
                    var u = s[l]
                      ...
                      , d = r.indexOf(Te(c));
                    if (-1 !== d && !f[t]) {
                        var g = (p = a[d]) && p.replace && p.replace(/wg-(\d+)=""(\s*)\/(\s*)>/g, 'wg-$1="">');
        ...
        if (r && r.length && Array.isArray(r))
            for (var i = 0, l = Ee(n, r.join(",")); i < l.length; i += 1) {
                ...
                if (u)
                    ...
                    u.includes(de + "/") || u.includes("/wg-cgi/"))
                        if (t && t !== o) {
                            var c = new RegExp(a + "/" + o + "/[^/]+/");
                            s.src = u.replace(c, a + "/" + o + "/" + t + "/")
                        } else {
                            var f = (s.weglot || {}).originalFrameSrc;
                            f && (s.src = f)
                        }
                    else {
    ...
    var dn, gn, pn, vn, _n, hn, mn, yn, wn, bn, kn, xn = {}, Sn = [], En = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, Cn = Array.isArray;
    function On(e, t) {
        for (var n in t)
            e[n] = t[n];
        return e
    ...
    function Nn(e, t, n) {
        ...
        if (arguments.length > 2 && (i.children = arguments.length > 3 ? dn.call(arguments, 2) : n),
    ...
    function Mn(e, t, n, r, a, o, i, l, s, u, c) {
        var f, d, g, p, v, _ = r && r.__k || Sn, h = t.length;
        for (n.__d = s,
        function(e, t, n) {
            var r, a, o, i, l, s = t.length, u = n.length, c = u, f = 0;
            for (e.__k = [],
            r = 0; r < s; r++)
                i = r + f,
                ...
                -1 !== l && (c--,
                (o = n[l]) && (o.__u |= 131072)),
                null == o || null === o.__v ? (-1 == l && f--,
                "function" != typeof a.type && (a.__u |= 65536)) : l !== i && (l == i - 1 ? f = l - i : l == i + 1 ? f++ : l > i ? c > s - i ? f += l - i : f-- : l < i && f++,
                l !== r + f && (a.__u |= 65536))) : (o = n[i]) && null == o.key && o.__e && 0 == (131072 & o.__u) && (o.__e == e.__d && (e.__d = Rn(o)),
                Jn(o, o, !1),
                n[i] = null,
                c--);
            if (c)
        ...
        s = n.__d,
        f = 0; f < h; f++)
            null != (g = n.__k[f]) && "boolean" != typeof g && "function" != typeof g && (d = -1 === g.__i ? xn : _[g.__i] || xn,
            g.__i = f,
            zn(e, g, d, a, o, i, l, s, u, c),
            p = g.__e,
            g.ref && d.ref != g.ref && (d.ref && Vn(d.ref, null, g),
            c.push(g.ref, g.__c || p, g)),
            null == v && null != p && (v = p),
            65536 & g.__u || d.__k === g.__k ? (s && "string" == typeof g.type && !e.contains(s) && (s = Rn(d)),
    ...
    function zn(e, t, n, r, a, o, i, l, s, u) {
        var c, f, d, g, p, v, _, h, m, y, w, b, k, x, S, E, C = t.type;
        ...
        e: if ("function" == typeof C)
            try {
                ...
                n.__c ? _ = (f = t.__c = n.__c).__ = f.__E : (m ? t.__c = f = new C(h,w) : (t.__c = f = new jn(h,w),
                f.constructor = C,
                f.render = Kn),
                y && y.sub(f),
                f.props = h,
                ...
                m && null != C.getDerivedStateFromProps && (f.__s == f.state && (f.__s = On({}, f.__s)),
                On(f.__s, C.getDerivedStateFromProps(h, f.__s))),
                g = f.props,
                p = f.state,
                f.__v = t,
                d)
                    m && null == C.getDerivedStateFromProps && null != f.componentWillMount && f.componentWillMount(),
                    m && null != f.componentDidMount && f.__h.push(f.componentDidMount);
                else {
                    if (m && null == C.getDerivedStateFromProps && h !== g && null != f.componentWillReceiveProps && f.componentWillReceiveProps(h, w),
                    !f.__e && (null != f.shouldComponentUpdate && !1 === f.shouldComponentUpdate(h, f.__s, w) || t.__v === n.__v)) {
                        for (t.__v !== n.__v && (f.props = h,
                        f.state = f.__s,
                        f.__d = !1),
                        t.__e = n.__e,
                        t.__k = n.__k,
                    ...
                    null != f.componentWillUpdate && f.componentWillUpdate(h, f.__s, w),
                    m && null != f.componentDidUpdate && f.__h.push((function() {
                ...
                f.state = f.__s,
                null != f.getChildContext && (r = On(On({}, r), f.getChildContext())),
                m && !d && null != f.getSnapshotBeforeUpdate && (v = f.getSnapshotBeforeUpdate(g, p)),
    ...
    function $n(e, t, n, r, a, o, i, l, s) {
        var u, c, f, d, g, p, v, _ = n.props, h = t.props, m = t.type;
        ...
        if (null === m)
            ...
            for (u in h)
                g = h[u],
                "children" == u ? d = g : "dangerouslySetInnerHTML" == u ? c = g : "value" == u ? p = g : "checked" == u ? v = g : "key" === u || l && "function" != typeof g || _[u] === g || qn(e, u, g, _[u], a);
            if (c)
                l || f && (c.__html === f.__html || c.__html === e.innerHTML) || (e.innerHTML = c.__html),
                t.__k = [];
            else if (f && (e.innerHTML = ""),
            Mn(e, Cn(d) ? d : [d], t, n, r, "foreignObject" === m ? "http://www.w3.org/1999/xhtml" : a, o, i, o ? o[0] : n.__k && Rn(n, 0), l, s),
            null != o)
                for (u = o.length; u--; )
                    null != o[u] && Tn(o[u]);
            l || (u = "value",
    ...
    function ya(e) {
        ...
        function E(e) {
            ...
            o(e),
            t = e,
            "WordPress" === Eo.technology_name && Eo.injectedData && !Eo.is_connect ? ft(t, (function(e) {
        ...
        ), [p]),
        {
            ...
            handleKeyDown: function(e) {
                ...
                p && E(p),
                S()) : e.keyCode === ga || e.keyCode === da ? (e.preventDefault(),
                void function(e) {
                    var t = e === ga ? "down" : "up"
                      , n = d.slice(-1).pop()
                      , r = d[0]
                    ...
                    if (l === d.length || -1 === l)
                        return;
                    v(d[l])
                }(e.keyCode)) : void (e.keyCode === fa && s && (e.preventDefault(),
                S()))
            },
            switchLanguage: E,
            toggleOpen: S
    ...
    var wa = {
      ...
      , ka = function(e) {
        ...
        var d = t.with_flags
          ...
          , p = t.flag_type
          , v = !!l && n === l
          , _ = f ? oa(n) : n.toUpperCase()
          , h = s ? "div" : "li"
          , m = pa.indexOf(p || "rectangle_mat")
          , y = d ? " wg-flags" + (a ? " flag-" + m + " legacy" : "") : ""
          , w = v && !s ? " focus" : ""
          , b = s ? " wgcurrent" : "";
        function k(e, t) {
            e.preventDefault(),
    ...
    var Sa, Ea, Ca, Oa = "default", Ta = function(e, t) {
        return function(n) {
            ...
            !function(e, t, n) {
                var r, a, o, i;
                gn.__ && gn.__(e, t),
                a = (r = "function" == typeof n) ? null : t.__k,
                o = [],
                i = [],
                zn(t, e = (!r && n || t).__k = Nn(An, null, [e]), a || xn, xn, t.namespaceURI, !r && n ? [n] : a ? null : t.firstChild ? dn.call(t.childNodes) : null, o, !r && n ? n : a ? a.__e : t.firstChild, r, i),
                Gn(o, e, i)
            }(Nn(Yr, {
                logger: na.error,
                displayError: !1
            ...
            var d = String(window.Weglot.switcherId++);
            return f.setAttribute("data-switcher-id", d),
            f.id = "weglot-switcher-" + d,
            f
        }
    }((function(e) {
        var t = e.style
    ...
    function Aa(e, t) {
        ...
        e && !e.ready) {
            ...
            if (!o) {
                ...
                i.insertBefore(u, l),
                e.ready = !0;
                for (var c = 0, d = t.querySelectorAll(".weglot-container:empty"); c < d.length; c += 1) {
                    f(d[c])
                }
                return u
            }
            ...
            for (var l = 0, s = Eo.switchers; l < s.length; l += 1) {
                ...
                if (!u.default) {
                    ...
                    if (c && "default" !== c.name) {
                        if (c.name) {
                            if (!Na(c)) {
                                var d = window.Weglot.switchers && window.Weglot.switchers[c.name];
                                d && d.addSwitchers(t)
                            }
                            ja()
                        }
    ...
    var Fa, Ua = null, Ha = [], Wa = [fe, "class", "id"], qa = [], Ba = [];
    function za(e, t) {
        Fa && clearTimeout(Fa);
          ...
          , v = function() {
            var e, t, n, r = new p, i = {}, u = null, v = 0, _ = function() {
                ...
                -1 !== u)
                    ...
                    var e = f(r.getAllResponseHeaders());
                    for (var t in e) {
                        var a = e[t];
                        if (!n.headers[t]) {
                            var o = t.toLowerCase();
            ...
            ,
            b.send = function(e) {
                for (var u, c, f = 0, g = ["type", "timeout", "withCredentials"]; f < g.length; f += 1)
                    (c = "type" === (u = g[f]) ? "responseType" : u)in b && (i[u] = b[c]);
                i.body = e;
                var p = d.listeners("before")
                  , v = function() {
                    if (!p.length)
                        return function() {
                    ...
                    ;
                    var f = p.shift();
                    1 === f.length ? e(f(i)) : 2 === f.length && i.async ? f(i, e) : e()
                };
                v()
            }
            ,
        ...
        if (n || !e || window.top !== window || !fo(e)) {
            ...
            Eo.force_translation) {
                for (var l = [], s = 0, u = r; s < u.length; s += 1) {
                    var c = u[s]
                      , d = c.closest ? c : c.parentNode;
                    Oe(d, Eo.force_translation) && l.push(c)
                }
                Xa(l)
            }
    ...
    function uo(e) {
        var t = Ye();
        e !== t && (Eo.visual_editor ? ft(e, (function(n) {
            if ("#" === n)
                return co(e, t);
    ...
    function fo(e) {
        ...
        }().includes(window.location.hostname) ? (ft(e, (function(e) {
    ...
    function To(e) {
        ...
        Eo.proxyFormat = pe,
        Eo.is_connect && !Eo.disable_internal_proxy && window.location.hostname !== de && (Eo.proxyFormat = ge),
    ...
    function Uo() {
        ...
        document.documentElement && -1 === ["cms.e.jimdo.com", de].indexOf(window.location.host) && -1 === window.location.pathname.indexOf("/wg-cgi/") && document.documentElement.setAttribute("translate", "no");
    ...
    function Ho() {
        if (Eo.api_key) {
            We("initialized", (function() {
                Eo.page_views_enabled && (Eo.is_connect ? ft(Eo.language_from, (function(e) {
                    return Ro(e)
                }
                )) : Ro())
            }

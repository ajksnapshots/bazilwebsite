var Weglot = function() {
    ...
    function y(e, t) {
        return void 0 === t && (t = !0),
        h("__validTextNodes", e, (function(e) {
    ...
    function w(e) {
        try {
            if (a.mergedSelectorRemove && T(e, a.mergedSelectorRemove))
                return !1
        } catch (e) {}
    ...
    function k(e) {
        ...
        for (var t = 0, n = e.children; t < n.length; t += 1) {
            var r = n[t];
            if ("wgNoTranslate"in r && r.wgNoTranslate || k(r))
                return !0
        }
        return !1
    }
    ...
    var E = function(e, t) {
        return function(n, r) {
            try {
                var a = r;
                return -1 !== a.indexOf(":") && (a = a.replace(/([^\\]):/g, "$1\\:")),
                n[e] ? n[e](a) : t
            } catch (a) {
                try {
                    return n[e] ? n[e](r) : t
    ...
    function A(e) {
        ...
        if (!t)
            return [];
        if (F(t),
        !a.whitelist || !a.whitelist.length)
    ...
    function j(e) {
        return [].concat(function(e) {
            ...
            return K.forEach((function(n) {
                for (var r, a, o, i = n.attribute, l = n.type, s = n.selectors, u = 0, c = (r = e,
                a = [],
                o = s.join(","),
                r.matches && r.matches(o) && a.push(r),
                r.childElementCount > 0 && a.push.apply(a, r.querySelectorAll(o)),
                a); u < c.length; u += 1) {
                    var d = c[u];
                    if (!S(d)) {
                        var f = i.get(d);
            ...
            var t, n = [], r = a.translation_engine >= 2, o = document.createTreeWalker(e, 4, R, !1);
            for (; t = o.nextNode(); ) {
                var i = (r && (w(t.parentNode) || t.parentNode.childNodes.length > 1) ? I : P)(t, o);
                i && n.push(i)
            }
            return n
        }(e))
    ...
    function I(e, t) {
        ...
        var o = function(e, t) {
            ...
            var o = e instanceof ShadowRoot && !e.clonable ? (i = e,
            ...
            if (e) {
                ...
                [e, (o.innerHTML || o.textContent || "").replace(/<!--[^>]*-->/g, ""), n]
            }
        }(e, t);
        if (o) {
            var i = o[0]
    ...
    function M(e, t) {
        if ("wgNoTranslate"in e && e.wgNoTranslate && !O(e, t) && (e.wgNoTranslate = !1),
        e.children)
            ...
            if (i && o.isConnected) {
                for (var l = 0, s = i; l < s.length; l += 1) {
                    var u = s[l]
                      ...
                      , g = u.translations
                      , p = g[t] || c;
                    (t === a.language_from || g[t] && c !== g[t]) && (d && (o.weglot.setted = !0,
                    q(o, p, d, c, e)),
                    f && (o.weglot.setted = !0,
                    f(o, p, c)))
                }
    ...
    function q(e, t, n, r, a) {
        ...
        if (N(t) && !N(r)) {
            if (!e.parentNode)
                return _.warn("Unable to translate some words, please contact support@weglot.com."),
                void _.warn(e, {
                    sendToDatadog: !1
                });
            if (1 === e.parentNode.childNodes.length)
                return e.parentNode.weglot = e.weglot,
                void (a ? a.push(e.parentNode) : q(e.parentNode, t, n, r));
            ...
            if (!i || i.innerHTML !== t) {
                ...
                a ? a.push(l) : q(e.parentNode, t, n, r)
            }
        } else
            e.textContent = t
    }
        ...
        for (var a = t.childNodes.length, o = 0; o < a; o++) {
            ...
            if (i = z(l)) {
                ...
                var u = s.used ? s.child.cloneNode(!0) : s.child
                  , c = B(u, l, n);
                if (c.contains(u))
                    return _.warn("There is an HTML error in the translation of: " + e.innerHTML.toString(), {
                        sendToDatadog: !1
                    }),
                    r;
                u.innerHTML = "",
    ...
    function J(e) {
            ...
            attribute: {
                ...
                set: function(e, t, n) {
                    ...
                    if (t === n) {
                        ...
                        $(e, t),
                        e.hasAttribute("srcset") && (e.setAttribute("wgsrcset", a),
        ...
        e.external_enabled) {
            var n = V(function() {
                ...
                return a ? a[1] : (_.warn("[Weglot] Unable to get current hostname"),
                t)
            }());
            t.push({
                type: 10,
        ...
        if (e.extra_definitions && e.extra_definitions.length)
            ...
            }, a = 0, o = e.extra_definitions; a < o.length; a += 1)
                r();
        return t
    }
    R.acceptNode = R;
    ...
    function X(e, t) {
        ...
        t.merged_selectors_remove && (a.mergedSelectorRemove = t.merged_selectors_remove.map((function(e) {
            return e.value
        }
        )).join(",")),
        {
            ...
            var t = e.URL
              , n = function(t, n) {
                ...
                if (n && (void 0 === e.location || n !== e.location.href)) {
                    n = n.toLowerCase(),
                    (r = (a = document.implementation.createHTMLDocument("")).createElement("base")).href = n,
                ...
                o.href = t,
                r && (a.body.appendChild(o),
                o.href = o.href);
                var i = a.createElement("input");
                if (i.type = "url",
                i.value = t,
                ":" === o.protocol || !/:/.test(o.href) || !i.checkValidity() && !n)
    ...
    function Ve() {
        ...
        var l = null
          ...
          , u = t.find((function(t) {
            ...
            if (f)
                return l = f.custom_code || f.language_to,
                !0;
            if (i) {
        ...
        return Ge.convertLocale = function(t, n, r, o) {
            ...
            if (t === a && !c)
                return f.slice(0, i + 1).concat(f.slice(i + 2)).join("/");
    ...
    function Ze(e, t) {
        ...
        for (var r = 0, a = e; r < a.length; r += 1) {
            var o = a[r];
            if (!o || !o.dataset || !o.dataset.wgOnlyDisplay)
                return;
    ...
    !function() {
        if (Object.keys(nt.slugs).length)
            return nt.slugs;
        try {
            var e = tt({
                type: "local"
            ...
            if (!e)
                return {};
            var t = e.getItem(_e);
            t && (Object.assign(nt, JSON.parse(t)),
            nt.slugs)
        } catch (e) {
            return {}
        }
    ...
    function ct(e, t, n) {
        ...
        n)
            ...
            r = new xe(Be().url),
            Eo.visual_editor && r.searchParams.has("url") && (r = new xe(r.searchParams.get("url"))),
        ...
        Eo.subdirectory && e && (r.pathname = Ve().convertLocale(e, r.pathname)),
        r.toString()
    }
    function dt(e, t) {
        ...
        [{
            ...
            for (var a = e.name, o = e.selector, i = e.testRegex, l = e.event, s = document.querySelectorAll(o.join(",")), u = function() {
                ...
                if (i.test(o) && !r.every((function(e) {
                    ...
                    e.setAttribute(a, o),
                    e.wgCheckoutListener && e.removeEventListener(l, e.wgCheckoutListener),
                    t !== Eo.language_from && Eo.fix_shopify_checkout_locale && (e.wgCheckoutListener = function(e) {
                        return e.preventDefault(),
                        e.stopPropagation(),
                        Eo.is_connect && !Eo.subdirectory ? (tt({
                            type: "cookie"
                        }).setItem("wg_checkout_redirect", t),
                        document.location.href = encodeURI((Eo.is_https ? "https:" : "http:") + "//" + Eo.host)) : vt(n),
                        !1
                    }
                    ,
                    e.addEventListener(l, e.wgCheckoutListener))
                }
            }, c = 0, d = s; c < d.length; c += 1)
                u()
        }
        ))
    }
    ...
    function mt(e) {
        var t, n, r, a = e || Ye(), o = document.getElementById("create_customer") || document.querySelector('form[action="' + (t = a,
        n = "/account",
        (Eo.is_connect && t !== Eo.language_from ? ft[n] ? ft[n] : (ot((function(e) {
            var a = e && e[t] ? st(n, e[t].original) : n;
            r = Eo.subdirectory ? Ve().convertLocale(t, a, Eo.language_from) : a
        }
        )),
        ft[n] = r,
        r) : n) + '"]')) || "string" == typeof Eo.customer_tag && Ce(document, Eo.customer_tag);
        if (o) {
    ...
    function wt(e) {
        ...
        if (!Eo.visual_editor && !Le()) {
            ...
            if (tt({
                ...
                tt({
                    type: "session"
                }).setItem("wg-cart-update-token", l),
                tt({
                    type: "session"
            ...
            for (var d = document.querySelectorAll('a[href*="/cart/"]'), f = "attributes[lang]=" + t, g = 0, p = d; g < p.length; g += 1) {
                ...
                if (_) {
                    ...
                    h && (_ = _.replace(/&?attributes\[lang\]=([a-zA-Z-]+)/g, ""),
                    v.setAttribute("href", _ + (h[1] ? "&" : "?") + f))
                }
            }
        }
    }
    ...
    function Ct() {
        if (kt)
            return kt;
        if (!Eo.api_key)
            return ee.warn("Weglot must be initialized to use it.", {
                sendToDatadog: !1
            }),
            [];
    ...
    function Mt() {
        try {
            Lt.setItem(Nt, JSON.stringify(At)),
            Lt.setItem(ve, JSON.stringify(jt))
        } catch (e) {}
    }
    var Ft = [{
    ...
    function qt(e, t) {
        ...
        if (!r && "boolean" != typeof r)
            return !0;
        if ("URI_MATCH" === n && Bt(t.url, r))
            return !0;
        if ("HOST_MATCH" === n && Bt(t.hostname, r))
            return !0;
        if ("TRANSLATION_URL_MATCH" === n && Bt(t.url, r))
            return !0;
        if ("PATH_MATCH" === n && Bt(t.pathname, r))
            return !0;
        if ("INTEGRATION" === n)
            return "proxy" === r && Eo.is_connect || "javascript" === r && !Eo.is_connect;
        if ("DOM_CONTAINS" === n) {
            var a = r.selector;
            if (Ce(document, a))
                return !0
        }
        return "IN_FRAME" === n ? r === ("with-window-top" === Le()) : ("object" == typeof r && "selector"in r && ["XML_ATTRIBUTE_VALUE", "XML_ROOT_ELEMENT_NAME"].includes(n),
        !1)
    }
    var Bt = function(e, t) {
        var n = t.type
    ...
    function $t(e, t) {
        ...
        var n, r, a = e.l_to, o = e.words, i = Eo.visual_editor || t.search, l = !i && (n = At[Eo.api_key],
        (r = n && n === Eo.versions.translation) || (delete jt[Eo.api_key],
        delete At[Eo.api_key],
        delete Rt[Eo.api_key],
        Mt()),
        r);
        if (!o || !o.length)
            return Promise.resolve({
        ...
        return s && s.isComplete ? Promise.resolve(s.words) : function(e) {
            var t, n = Eo.versions && Eo.versions.translation || 1, r = ["api_key=" + Eo.api_key, "v=" + n], a = "https://" + (Eo.bypass_cdn_api ? "api.weglot.com" : "cdn-api-weglot.com") + "/translate?" + r.join("&"), o = Eo.previewHash ? {
            ...
            return i || o.forEach((function(t, n) {
                ...
                o = u,
                i = a,
                (s = Dt(r)) ? s[i] = o : (jt[Eo.api_key] || (jt[Eo.api_key] = {}),
                jt[Eo.api_key][r] = ((l = {})[i] = o,
                l)),
                Rt[Eo.api_key] || (Rt[Eo.api_key] = {}),
                Rt[Eo.api_key][i] || (Rt[Eo.api_key][i] = {}),
                Rt[Eo.api_key][i][o] = r,
                At[Eo.api_key] = Eo.versions.translation,
                Ie(Mt)()
            }
            )),
            e
    ...
    function nn(e) {
        ...
        return !t.weglot || !t.weglot.content || !t.weglot.content.some((function(e) {
            var t, r = e.original, a = e.translations;
            return r === n || (t = a,
    ...
    function rn(e) {
        for (var t = [], n = 0, r = e; n < r.length; n += 1) {
            var a = r[n];
            -1 === Xt.indexOf(a) && t.push(a)
        }
        return [].push.apply(Xt, t),
        t
    }
    function an(e, t) {
        void 0 === e && (e = Xt),
    ...
    function ln(e) {
        var t = Eo.language_from
          ...
          , i = Eo.languages;
        if (n === pe)
            return "https://" + fe + "/" + r + "/" + t + "/" + e + "/";
        if (a)
            return "https://" + o + "/" + e + "/" + "wg-cgi/";
        ...
        if (r && r.length && Array.isArray(r))
            for (var i = 0, l = Ee(n, r.join(",")); i < l.length; i += 1) {
                var s = l[i]
                  , u = s.src;
                if (u)
                    if (s.weglot || (s.weglot = {}),
                    u.includes(fe + "/") || u.includes("/wg-cgi/"))
                        if (t && t !== o) {
                        ...
                        if (s.weglot.originalFrameSrc || (s.weglot.originalFrameSrc = u),
                        t === o)
                            continue;
                        try {
                            var f = ln(t);
        ...
        if (e.data && "null" !== e.origin) {
            ...
            if (n) {
                if ("Weglot.iframe" === n) {
                    ...
                    return e.source.postMessage(a, e.origin),
                    void sn.push(e.source)
                }
                "Weglot.setLanguage" !== n || uo(r)
            }
        }
    }
    var fn, gn, pn, vn, _n, hn, mn, yn, wn, bn, kn, xn = {}, Sn = [], En = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, Cn = Array.isArray;
    function On(e, t) {
        for (var n in t)
            e[n] = t[n];
        return e
    ...
    function Nn(e, t, n) {
        ...
        if (arguments.length > 2 && (i.children = arguments.length > 3 ? fn.call(arguments, 2) : n),
    ...
    function Ln(e, t, n, r, a) {
        ...
        return null == a && null != gn.vnode && gn.vnode(o),
        o
    }
    function An(e) {
        return e.children
    ...
    function Dn() {
        var e, t, n, r, a, o, i, l;
        for (vn.sort(mn); e = vn.shift(); )
            e.__d && (t = vn.length,
            r = void 0,
            o = (a = (n = e).__v).__e,
            i = [],
            l = [],
            n.__P && ((r = On({}, a)).__v = a.__v + 1,
            gn.vnode && gn.vnode(r),
            zn(n.__P, r, a, n.__n, n.__P.namespaceURI, 32 & a.__u ? [o] : null, i, null == o ? Rn(a) : o, !!(32 & a.__u), l),
            r.__v = a.__v,
            r.__.__k[r.__i] = r,
            Gn(i, r, l),
            r.__e != o && In(r)),
            vn.length > t && vn.sort(mn));
        Dn.__r = 0
    }
    function Mn(e, t, n, r, a, o, i, l, s, u, c) {
        var d, f, g, p, v, _ = r && r.__k || Sn, h = t.length;
        for (n.__d = s,
        function(e, t, n) {
            var r, a, o, i, l, s = t.length, u = n.length, c = u, d = 0;
            for (e.__k = [],
            r = 0; r < s; r++)
                i = r + d,
                null != (a = e.__k[r] = null == (a = t[r]) || "boolean" == typeof a || "function" == typeof a ? null : "string" == typeof a || "number" == typeof a || "bigint" == typeof a || a.constructor == String ? Ln(null, a, null, null, null) : Cn(a) ? Ln(An, {
                    children: a
                }, null, null, null) : void 0 === a.constructor && a.__b > 0 ? Ln(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v) : a) ? (a.__ = e,
                a.__b = e.__b + 1,
                l = Hn(a, n, i, c),
                a.__i = l,
                o = null,
                -1 !== l && (c--,
                (o = n[l]) && (o.__u |= 131072)),
                null == o || null === o.__v ? (-1 == l && d--,
                "function" != typeof a.type && (a.__u |= 65536)) : l !== i && (l == i - 1 ? d = l - i : l == i + 1 ? d++ : l > i ? c > s - i ? d += l - i : d-- : l < i && d++,
                l !== r + d && (a.__u |= 65536))) : (o = n[i]) && null == o.key && o.__e && 0 == (131072 & o.__u) && (o.__e == e.__d && (e.__d = Rn(o)),
                Jn(o, o, !1),
                n[i] = null,
                c--);
            if (c)
                for (r = 0; r < u; r++)
                    null != (o = n[r]) && 0 == (131072 & o.__u) && (o.__e == e.__d && (e.__d = Rn(o)),
                    Jn(o, o))
        }(n, t, _),
        s = n.__d,
        d = 0; d < h; d++)
            null != (g = n.__k[d]) && "boolean" != typeof g && "function" != typeof g && (f = -1 === g.__i ? xn : _[g.__i] || xn,
            g.__i = d,
            zn(e, g, f, a, o, i, l, s, u, c),
            p = g.__e,
            g.ref && f.ref != g.ref && (f.ref && Vn(f.ref, null, g),
            c.push(g.ref, g.__c || p, g)),
            null == v && null != p && (v = p),
            65536 & g.__u || f.__k === g.__k ? (s && "string" == typeof g.type && !e.contains(s) && (s = Rn(f)),
            s = Fn(g, s, e)) : "function" == typeof g.type && void 0 !== g.__d ? s = g.__d : p && (s = p.nextSibling),
            g.__d = void 0,
            g.__u &= -196609);
        n.__d = s,
        n.__e = v
    ...
    function Un(e, t) {
        return t = t || [],
        null == e || "boolean" == typeof e || (Cn(e) ? e.some((function(e) {
            Un(e, t)
        }
        )) : t.push(e)),
        t
    ...
    function Hn(e, t, n, r) {
        var a = e.key
          ...
          , l = n + 1
          , s = t[n];
        if (null === s || s && a == s.key && o === s.type && 0 == (131072 & s.__u))
            return n;
    ...
    function qn(e, t, n, r, a) {
        ...
        e: if ("style" === t)
            if ("string" == typeof n)
                ...
                r)
                    for (t in r)
                        n && t in n || Wn(e.style, t, "");
                if (n)
                    for (t in n)
                        r && n[t] === r[t] || Wn(e.style, t, n[t])
            }
        else if ("o" === t[0] && "n" === t[1])
            ...
            e.l[t + o] = n,
            n ? r ? n.u = r.u : (n.u = yn,
            e.addEventListener(t, o ? bn : wn, o)) : e.removeEventListener(t, o ? bn : wn, o);
        else {
    ...
    function zn(e, t, n, r, a, o, i, l, s, u) {
        ...
        e: if ("function" == typeof C)
            try {
                ...
                n.__c ? _ = (d = t.__c = n.__c).__ = d.__E : (m ? t.__c = d = new C(h,w) : (t.__c = d = new jn(h,w),
                d.constructor = C,
                d.render = Kn),
                y && y.sub(d),
                d.props = h,
                ...
                m && null != C.getDerivedStateFromProps && (d.__s == d.state && (d.__s = On({}, d.__s)),
                On(d.__s, C.getDerivedStateFromProps(h, d.__s))),
                g = d.props,
                p = d.state,
                d.__v = t,
                f)
                    m && null == C.getDerivedStateFromProps && null != d.componentWillMount && d.componentWillMount(),
                    m && null != d.componentDidMount && d.__h.push(d.componentDidMount);
                else {
                    if (m && null == C.getDerivedStateFromProps && h !== g && null != d.componentWillReceiveProps && d.componentWillReceiveProps(h, w),
                    !d.__e && (null != d.shouldComponentUpdate && !1 === d.shouldComponentUpdate(h, d.__s, w) || t.__v === n.__v)) {
                        for (t.__v !== n.__v && (d.props = h,
                        d.state = d.__s,
                        d.__d = !1),
                        t.__e = n.__e,
                        t.__k = n.__k,
                    ...
                    null != d.componentWillUpdate && d.componentWillUpdate(h, d.__s, w),
                    m && null != d.componentDidUpdate && d.__h.push((function() {
                ...
                d.state = d.__s,
                null != d.getChildContext && (r = On(On({}, r), d.getChildContext())),
                m && !f && null != d.getSnapshotBeforeUpdate && (v = d.getSnapshotBeforeUpdate(g, p)),
                Mn(e, Cn(E = null != c && c.type === An && null == c.key ? c.props.children : c) ? E : [E], t, n, r, a, o, i, l, s, u),
                d.base = t.__e,
                t.__u &= -161,
                d.__h.length && i.push(d),
                _ && (d.__E = d.__ = null)
                ...
                s || null != o ? (t.__e = l,
                t.__u |= s ? 160 : 32,
                o[o.indexOf(l)] = null) : (t.__e = n.__e,
                t.__k = n.__k),
                gn.__e(e, t, n)
            }
        else
            null == o && t.__v === n.__v ? (t.__k = n.__k,
            t.__e = n.__e) : t.__e = $n(n.__e, t, n, r, a, o, i, s, u);
        (c = gn.diffed) && c(t)
    }
    function Gn(e, t, n) {
        t.__d = void 0;
    ...
    function $n(e, t, n, r, a, o, i, l, s) {
        var u, c, d, f, g, p, v, _ = n.props, h = t.props, m = t.type;
        if ("svg" === m ? a = "http://www.w3.org/2000/svg" : "math" === m ? a = "http://www.w3.org/1998/Math/MathML" : a || (a = "http://www.w3.org/1999/xhtml"),
        null != o)
        ...
        if (null == e) {
            ...
            e = document.createElementNS(a, m, h.is && h),
            o = null,
            l = !1
        }
        if (null === m)
            _ === h || l && e.data === h || (e.data = h);
        else {
            if (o = o && fn.call(e.childNodes),
            _ = n.props || xn,
            !l && null != o)
                for (_ = {},
            ...
            for (u in _)
                ...
                "children" == u)
                    ...
                    if ("value" == u && "defaultValue"in h || "checked" == u && "defaultChecked"in h)
                        continue;
                    qn(e, u, null, g, a)
                }
            for (u in h)
                g = h[u],
                "children" == u ? f = g : "dangerouslySetInnerHTML" == u ? c = g : "value" == u ? p = g : "checked" == u ? v = g : "key" === u || l && "function" != typeof g || _[u] === g || qn(e, u, g, _[u], a);
            if (c)
                l || d && (c.__html === d.__html || c.__html === e.innerHTML) || (e.innerHTML = c.__html),
                t.__k = [];
            else if (d && (e.innerHTML = ""),
            Mn(e, Cn(f) ? f : [f], t, n, r, "foreignObject" === m ? "http://www.w3.org/1999/xhtml" : a, o, i, o ? o[0] : n.__k && Rn(n, 0), l, s),
            null != o)
                for (u = o.length; u--; )
                    null != o[u] && Tn(o[u]);
            l || (u = "value",
            void 0 !== p && (p !== e[u] || "progress" === m && !p || "option" === m && p !== _[u]) && qn(e, u, p, _[u], a),
            u = "checked",
            void 0 !== v && v !== e[u] && qn(e, u, v, _[u], a))
        }
        return e
    }
    function Vn(e, t, n) {
    ...
    function Jn(e, t, n) {
        ...
        (r = e.ref) && (r.current && r.current !== e.__e || Vn(r, null, t)),
        null != (r = e.__c)) {
        ...
        if (r = e.__k)
            for (a = 0; a < r.length; a++)
                r[a] && Jn(r[a], t, n || "function" != typeof e.type);
        n || null == e.__e || Tn(e.__e),
    ...
    gn = {
        __e: function(e, t, n, r) {
            for (var a, o, i; t = t.__; )
                if ((a = t.__c) && !a.__)
                    try {
                        if ((o = a.constructor) && null != o.getDerivedStateFromError && (a.setState(o.getDerivedStateFromError(e)),
                        i = a.__d),
                        null != a.componentDidCatch && (a.componentDidCatch(e, r || {}),
                        i = a.__d),
                        i)
                            return a.__E = a
                    } catch (t) {
    ...
    jn.prototype.setState = function(e, t) {
        var n;
        n = null != this.__s && this.__s !== this.state ? this.__s : this.__s = On({}, this.state),
        "function" == typeof e && (e = e(On({}, n), this.props)),
        e && On(n, e),
    ...
    ,
    jn.prototype.render = An,
    vn = [],
    hn = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout,
    mn = function(e, t) {
    ...
    bn = Bn(!0),
    kn = 0;
    var Yn, Zn, Qn, er, tr = 0, nr = [], rr = gn, ar = rr.__b, or = rr.__r, ir = rr.diffed, lr = rr.__c, sr = rr.unmount, ur = rr.__;
    function cr(e, t) {
        rr.__h && rr.__h(Zn, e, tr || t),
        tr = 0;
        var n = Zn.__H || (Zn.__H = {
            __: [],
            __h: []
    ...
    function dr(e) {
        ...
        function(e, t, n) {
            var r = cr(Yn++, 2);
            if (r.t = e,
            !r.__c && (r.__ = [n ? n(t) : wr(void 0, t), function(e) {
    ...
    rr.diffed = function(e) {
        ir && ir(e);
        var t = e.__c;
        t && t.__H && (t.__H.__h.length && (1 !== nr.push(t) && er === rr.requestAnimationFrame || ((er = rr.requestAnimationFrame) || _r)(pr)),
    ...
    (xr.prototype = new jn).isPureReactComponent = !0,
    xr.prototype.shouldComponentUpdate = function(e, t) {
    ...
    function Tr(e, t, n) {
        ...
        e.__c.__H = null),
        null != (e = br({}, e)).__c && (e.__c.__P === n && (e.__c.__P = t),
        e.__c = null),
    ...
    Lr.prototype.render = function(e, t) {
        ...
        return a && (a.__u &= -33),
        [Nn(An, null, t.__a ? null : e.children), a]
    }
    ;
    ...
    ;
    var Ir = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103
      , Pr = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/
        ...
        "string" == typeof e.type && function(e) {
            ...
            for (var a in t) {
                ...
                if (!("value" === a && "defaultValue"in t && null == o || Fr && "children" === a && "noscript" === n || "class" === a || "className" === a)) {
                    var i = a.toLowerCase();
                    "defaultValue" === a && "value"in t && null == t.value ? a = "value" : "download" === a && !0 === o ? o = "" : "translate" === i && "no" === o ? o = !1 : "ondoubleclick" === i ? a = "ondblclick" : "onchange" !== i || "input" !== n && "textarea" !== n || Ur(t.type) ? "onfocus" === i ? a = "onfocusin" : "onblur" === i ? a = "onfocusout" : Dr.test(a) ? a = i : -1 === n.indexOf("-") && Pr.test(a) ? a = a.replace(Mr, "-$&").toLowerCase() : null === o && (o = void 0) : i = a = "oninput",
            ...
            Object.defineProperty(r, "className", zr)) : (t.className && !t.class || t.class && t.className) && (r.class = r.className = t.className),
            e.props = r
        }(e),
        e.$$typeof = Ir,
        Gr && Gr(e)
        ...
        var t = {}
          ...
          , a = function(e, t) {
            function n(e) {
                ...
                t ? !t(this.props, e) || !r : kr(this.props, e)
            }
            function r(t) {
        ...
        var r = e.children
          , a = function(e) {
            var t = cr(Yn++, 10)
              , n = dr();
            return t.__ = e,
            Zn.componentDidCatch || (Zn.componentDidCatch = function(e, r) {
                t.__ && t.__(e, r),
                n[1](e)
            }
            ),
    ...
    function la(e) {
        return function(e, t, n) {
            ...
            if (t.language_from === e)
                return t.language_from_custom_flag || ia(e, n);
            var r = e.toLowerCase()
    ...
    function ma(e, t, n) {
        ...
        fr((function() {
            ...
            if (e && 1 !== e) {
                ...
                a = n,
                s = Eo.button_style && Eo.button_style.custom_css,
                u = r.map((function(e) {
                    var t = e.selector
                      , n = e.declarations;
    ...
    function ya(e) {
        ...
        function E(e) {
            if (Eo.switcher_editor)
                return u(!1);
            var t;
            o(e),
            t = e,
            "WordPress" === Eo.technology_name && Eo.injectedData && !Eo.is_connect ? dt(t, (function(e) {
        ...
        ), [p]),
        {
            ...
            handleKeyDown: function(e) {
                return e.keyCode === ca ? (e.preventDefault(),
                p && E(p),
                S()) : e.keyCode === ga || e.keyCode === fa ? (e.preventDefault(),
                void function(e) {
                    var t = e === ga ? "down" : "up"
                      , n = f.slice(-1).pop()
                      , r = f[0]
                    ...
                    if (!p || !s) {
                        return v("down" === t ? r : n),
                        void (!s && ("up" === t && o || "down" === t && !o) && k())
                    }
                    if (!o && "up" === t && p === r || o && "down" === t && p === n)
                        return void S();
                    var i = "up" === t ? -1 : 1
                      , l = f.indexOf(p) + i;
                    if (l === f.length || -1 === l)
                        return;
                    v(f[l])
                }(e.keyCode)) : void (e.keyCode === da && s && (e.preventDefault(),
                S()))
            },
            switchLanguage: E,
            toggleOpen: S
    ...
    var Sa, Ea, Ca, Oa = "default", Ta = function(e, t) {
        return function(n) {
            var r = n || {}
              , a = r.style;
            void 0 === a && (a = {});
            ...
            !function(e, t, n) {
                ...
                a = [],
                o = [],
                zn(t, e = t.__k = Nn(An, null, [e]), r || xn, xn, t.namespaceURI, r ? null : t.firstChild ? fn.call(t.childNodes) : null, a, r ? r.__e : t.firstChild, !1, o),
                Gn(a, e, o)
            }(Nn(Yr, {
                logger: na.error,
                displayError: !1
            ...
            return d.setAttribute("data-switcher-id", f),
        ...
        var k = t.is_dropdown
          ...
          , O = function() {
            for (var e, t, n = arguments, r = 0, a = "", o = arguments.length; r < o; r++)
                (e = n[r]) && (t = Xn(e)) && (a && (a += " "),
                a += t);
            return a
        }({
    ...
    function Aa(e, t) {
        ...
        e && !e.ready) {
            ...
            if (!o) {
                ...
                if (u.weglotSwitcher = e,
                La.push(u),
                s)
                    return u.classList.add("wg-default"),
                    document.body.appendChild(u),
                    e.ready = !0,
                    u;
                u.setAttribute("data-switcher-style-opt", JSON.stringify(n)),
                i.insertBefore(u, l),
                e.ready = !0;
    ...
    function Ra(e) {
        ...
        !(Ct().length < 2 || Eo.hide_switcher || Eo.switcher_editor)) {
    ...
    We("onCurrentLocationChanged", (function() {
        ...
        Sa = null,
        Ea = null,
        Eo.button_style.ready = !1,
        Eo.switchers.map((function(e) {
            return e.ready = !1
        }
        )),
        Ra()
        ...
        Eo.translate_event.forEach((function(t) {
            for (var n = Ee(document.body, t.selector), r = function() {
                ...
                if (n.alreadyListeningEventInput)
                    return !n.alreadyListeningEventInput.isConnected && Ia < 10 && (Ia++,
    ...
    var Fa, Ua = null, Ha = [], Wa = [de, "class", "id"], qa = [], Ba = [];
    function za(e, t) {
        Fa && clearTimeout(Fa);
        ...
        Ha.length && (Fa = setTimeout((function() {
            Ra(e),
            Pa(),
            Eo.is_connect && !Eo.subdirectory && function(e) {
                var t = window.location.hostname;
                if ([Eo.host].concat(i).includes(t))
                    return;
                for (var n = 0, r = e; n < r.length; n += 1)
                    for (var a = r[n], o = Ee(a, "[href]"), l = function() {
                        ...
                        if (!S(e)) {
                            ...
                            if (t && t.includes("//" + Eo.host)) {
                                ...
                                void 0 === n && (n = "/"),
                                Et(void 0, n) || ot((function(n) {
                                    e.setAttribute("href", ct(Ye(), n, t))
                                }
                                ))
                            }
                        }
                    }, s = 0, u = o; s < u.length; s += 1)
                        l()
            }(Ha),
            Eo.proxify_iframes && Eo.proxify_iframes.length && Ha.forEach((function(e) {
                return un({
                    node: e
                })
            }
                                ...
                                for (var a = tn(e, (function(e) {
                                    ...
                                    return !function(e) {
                                        if (e.weglot && e.weglot.dynamic > 20) {
                                            if (e.wgBypassDynamicLimit)
                                                return !1;
                                            if (Eo.dangerously_bypass_dynamic_limit) {
                                                var t = e.closest ? e : e.parentNode;
                                                if (Oe(t, Eo.dangerously_bypass_dynamic_limit))
                                                    return e.wgBypassDynamicLimit = !0,
                                                    !1
                                            }
                                            return !0
                                        }
                                    ...
                                    var l = i[o];
                                    Eo.ignoreDynamicFragments && !document.body.contains(l) || (l.weglot.dynamic || (l.weglot.dynamic = 0),
                                    l.weglot.dynamic++,
                                    r.push(l))
                                }
                                return null
                            ...
                            case "childList":
                                ...
                                for (var g = 0, p = d; g < p.length; g += 1) {
                                    ...
                                    for (var h = 0; h < _.length; h++) {
                                        var m = _[h];
                                        t(m) && Pe(m) && !S(m) && (a(m.contentWindow.document),
                                        Va(m.contentWindow.document))
                                    }
                                }
                            }
                        }
    ...
    function Ja(e) {
        if (!Eo.dynamics || 0 === Eo.dynamics.length || !e)
            return !1;
        if (!e.closest)
            return Ja(e.parentNode);
    ...
    function Xa(e) {
        ...
        if (n !== Eo.language_from) {
            ...
            Ka.times.length && (Ka.timeout || Ka.times.length >= 10))
                return Ka.nodes = Ka.nodes.concat(e),
                void (Ka.timeout = setTimeout((function() {
                    return Xa()
                }
                ), 1e3));
    ...
    var oo = function() {
        ...
        var n = t
            ...
            var n = {}
              ...
              , a = {
                addEventListener: function(e, t, a) {
                    n[e] = r(e),
                    n[e].indexOf(t) >= 0 || (a = void 0 === a ? n[e].length : a,
                    n[e].splice(a, 0, t))
                },
          ...
          , p = n.XMLHttpRequest
          , v = function() {
            var e, t, n, r = new p, i = {}, u = null, v = 0, _ = function() {
                if (n.status = u || r.status,
                ...
                for (; e > v && v < 4; )
                    ...
                    4 === v && (!1 === i.async ? m() : setTimeout(m, 0))
            }, w = function(e) {
                if (4 === e) {
                    var t = f.listeners("after")
                      , r = function() {
                        if (t.length > 0) {
                            var e = t.shift();
                            2 === e.length ? (e(i, n),
                            r()) : 3 === e.length && i.async ? e(i, n, r) : r()
                        } else
                            y(4)
                    };
                    r()
            ...
            r.onreadystatechange = function() {
                ...
                function() {
                    if (r.responseType && "text" !== r.responseType)
                        "document" === r.responseType ? (n.xml = r.responseXML,
                        n.data = r.responseXML) : n.data = r.response;
                    else {
                        n.text = r.responseText,
                        n.data = r.responseText;
                        try {
                            n.xml = r.responseXML
                        } catch (e) {}
                    }
            ...
            ,
            b.send = function(e) {
                for (var u, c, d = 0, g = ["type", "timeout", "withCredentials"]; d < g.length; d += 1)
                    (c = "type" === (u = g[d]) ? "responseType" : u)in b && (i[u] = b[c]);
                i.body = e;
                var p = f.listeners("before")
                  , v = function() {
                    if (!p.length)
                        return function() {
                            for (var e = 0, n = (s(o, r, b),
                            b.upload && s(o.concat(a), r.upload, b.upload),
                            t = !0,
                            r.open(i.method, i.url, i.async, i.user, i.pass),
                            ["type", "timeout", "withCredentials"]); e < n.length; e += 1)
                    ...
                    var e = function(e) {
                        if ("object" == typeof e && ("number" == typeof e.status || "number" == typeof n.status))
                            return l(e, n),
                ...
                var a = this
                  ...
                  , s = function(e) {
                    if (!i.length)
                        return l(e);
                    var t = i.shift();
                    return 2 === t.length ? (t(n, e),
                    s(e)) : 3 === t.length ? t(n, e, s) : s(e)
                }
                  , u = function(e) {
                    if (void 0 !== e) {
                  ...
                  , d = function() {
                    return function(e, t, n, r) {
                        ...
                        return e instanceof Request && a.body instanceof ReadableStream && (a.body = yield new Response(a.body).text()),
                        h(t, a).then((function(e) {
                            return s(e)
                        }
                        )).catch((function(e) {
                            return l = r,
            ...
            if (i)
                ...
                void t()) : void function(e, t, n) {
                    var r = n.target_source
                      ...
                      , l = e.body;
                    function s(e, t) {
                        "reverse_translate" === o && Jt(e, t),
                        "reverse_handle_path" === o && t(Ve().convertLocale(Eo.language_from, e))
                    }
                    switch (r) {
                    case "url_query":
                        try {
                            var u = new xe(i,"https://" + window.location.hostname)
                              , c = u.searchParams.get(a);
                            if (!c)
                                return void t();
                            s(c, (function(n) {
                                u.searchParams.set(a, n),
                                e.url = u.toString(),
                                t()
                            }
                            ))
                    ...
                    case "url":
                        ...
                        break;
                    case "url_encoded_form_payload":
                        try {
                            var _ = new xe("https://unused.com?" + l).searchParams
                              , h = _.get(a);
                            if (!h)
                                return void t();
                            s(h, (function(n) {
                    ...
                    case "json_payload":
                        try {
                            var y = JSON.parse(l)[a];
                            if (!y)
                                return void t();
                            s(y, (function(n) {
                                var r;
                                e.body = JSON.stringify(Object.assign({}, JSON.parse(l), ((r = {})[a] = n,
                                r))),
                                t()
                            }
                            ))
    ...
    function so(e, t, n) {
        if (n || !e || window.top !== window || !fo(e)) {
            ...
            var a, o, i = Et();
            if (e && t && !i && Tt(e),
            !Eo.is_connect || Eo.dynamicPushState || !i && e !== Eo.language_from ? function(e) {
                void 0 === e && (e = !0);
                ...
                if ($a = e)
                    ...
                    n && qa.length > 0)
                        for (var r = function() {
                            ...
                            r()
                        }, a = 0, o = qa; a < o.length; a += 1)
                            r();
                    else
                        qa = []
            }() : function() {
                if (0 !== Ba.length) {
                    for (var e = 0, t = Ba; e < t.length; e += 1)
                        t[e].disconnect();
                    qa = []
                }
            }(),
            a = Eo.xhr_hooks,
            o = Eo.is_connect,
            !(a && Array.isArray(a) && a.some(lo)) || o && Et() || (oo.enable(),
            oo.before(io)),
            ...
            n || i)
                co(e);
            else if (Eo.is_connect && !i && Fe("onConnectPageLoad", e),
            ...
            i && !i.language_button_displayed && i.allExcluded || Ra(),
            i || (Eo.remove_unused_link_hooks && function() {
                var e = Ct()
            ...
            function() {
                ...
                un({}),
                Me("onPageLanguageSet", cn),
                "with-window-top" === Le() && window.top.postMessage({
    ...
    function co(e, t) {
        if (!Ct().includes(e))
            return to(),
            void ee.warn(e + " isn't a language you have added", {
                sendToDatadog: !1
            });
        (Eo.auto_switch || Eo.geo_auto_switch) && eo(e);
        var n = Et();
        if (Eo.is_connect || n || Tt(e),
        !fo(e)) {
            if (Eo.loading_bar && function() {
                try {
                    ...
                    e.id = "wg_progress",
                    e.innerHTML = '<div class="wg-progress-bar" role="progressbar" aria-label="Page is loading"></div>',
            ...
            Et())
                ...
                void no();
            if (e === Eo.language_from)
                return Fe("onPageLanguageSet", e),
                to(),
                on(null, e),
                Eo.loading_bar && no(),
                document.documentElement.setAttribute("lang", e),
                void qe("languageChanged", e, t || "");
            Vt(an(), e).then((function(n) {
                to(),
                on(n, e),
                document.documentElement.setAttribute("lang", e),
                qe("languageChanged", e, t || ""),
                Eo.loading_bar && no()
            }
            )).catch((function(e) {
                throw Eo.loading_bar && no(),
                to(),
                tt().removeItem(ue),
                e
            }
        ...
        Eo.translate_search && !Eo.switcher_editor && function() {
            ...
            if (t) {
                for (var n = 0, r = Ee(document, e); n < r.length; n += 1) {
                    ...
                    var o = void 0;
                    -1 !== window.location.search.indexOf(t + "=") && a.elements && a.elements[t] && (o = Q.get("wg-search-form")) && (a.elements[t].value = o)
                }
                Q.erase({
                    name: "wg-search-form",
                    options: Eo
                ...
                ee.warn("Search parameter name required for search translation.", {
                    sendToDatadog: !1
                })
        }()
    }
    ...
    function _o(e) {
        go.forEach((function(t) {
            ...
            r.forEach((function(e) {
                ...
                Eo.linkHooksConfig && Eo.linkHooksConfig[i] && Eo.linkHooksConfig[i](e)
            }
            ))
        }
        ))
    ...
    function ho(e, t) {
        ...
        e === Ye() && (t.classList.add("weglot-link--active"),
        Eo.linkHooksConfig && Eo.linkHooksConfig.onLinkActive && Eo.linkHooksConfig.onLinkActive(t)),
        dt(e, (function(e) {
    ...
    mo[he.shopify.id] = function() {
        ...
        We("initialized", (function() {
            ...
            vt(e)),
            window.langify && ee.log("%c Please, uninstall langify to properly use Weglot", {
                sendToDatadog: !1
            }),
            Ae() || !Eo.order_tag || Eo.is_connect && Eo.language_from !== Ye() || wt(),
            _t();
            ...
            window.fetch = function() {
                if ("/wallets/checkouts.json" === arguments[0])
                    try {
                        ...
                        Eo.cart_attributes.forEach((function(t) {
        ...
        window.wixBiSession && "bolt" === window.wixBiSession.renderType) {
            var t = 0
              , n = setInterval((function() {
                (document.body && window.sssr || 40 === t) && (qe("start"),
                clearInterval(n)),
                t++
            }
            ), 100);
    ...
    function xo(e) {
        ...
        t.switchers.length && t.switchers[0].styleOpt && (t.switchers = t.switchers.map(bo)),
    ...
    function To(e) {
        ...
        !Eo.technology_id) {
            ...
            n && he[n] && (e.technology_id = he[n].id,
            e.technology_name = he[n].name)
        }
        var r, a, o, i = (r = e.technology_id) ? Ht(mo[r] ? mo[r]() : {}, r) : {}, s = Object.assign({}, we, i);
        if (Object.assign(Eo, s, e),
        Eo.whitelist && !Array.isArray(Eo.whitelist) && (Eo.whitelist = String(Eo.whitelist).split(",").map((function(e) {
            return {
                value: e
            }
        }
        ...
        me.forEach((function(e) {
            var t, n;
            Eo[e] !== s[e] && (Eo[e] = (t = Eo[e],
            (n = s[e]) ? Array.isArray(t) ? [].concat(t, n) : "object" == typeof t ? Object.assign({}, t, n) : (t = t.split(",").filter((function(e) {
                return e
            }
        ...
        Eo.button_style && Eo.button_style.custom_css && c(Eo.button_style.custom_css, "weglot-custom-style"),
        Eo.switchers && 0 !== Eo.switchers.length ? Eo.switchers = Eo.switchers.map((function(e) {
        ...
        Eo.api_key.length < 36 && (Eo.translation_engine = 1),
        Eo.excluded_blocks_remove && (Eo.excluded_blocks = Eo.excluded_blocks.filter((function(e) {
        ...
        Eo.excluded_blocks = Eo.excluded_blocks.filter((function(e) {
            return je(e.value)
        }
        )),
        ...
        Eo.is_tld = !1,
        i.forceDisableConnect && (Eo.is_connect = !1),
        Eo.is_connect && !Eo.previewHash) {
        ...
        Eo.proxyFormat = pe,
        Eo.is_connect && !Eo.disable_internal_proxy && window.location.hostname !== fe && (Eo.proxyFormat = ge),
        Array.isArray(Eo.force_translation) && (Eo.force_translation = Eo.force_translation.join(",")),
        Eo
    }
    var No = {
    ...
    !function(e) {
        ...
        if (t.length) {
            !function(e, t, n) {
                ...
                i.src = e,
                i.addEventListener ? (i.addEventListener("load", a, !1),
                i.addEventListener("error", a, !1)) : i.readyState && (i.onreadystatechange = a),
                o.insertBefore(i, o.firstChild)
    ...
    function Uo() {
        ...
        document.documentElement && -1 === ["cms.e.jimdo.com", fe].indexOf(window.location.host) && -1 === window.location.pathname.indexOf("/wg-cgi/") && document.documentElement.setAttribute("translate", "no");
    ...
    function Bo(e) {
        try {
            ...
            var a = t[1].split("&").map((function(e) {
                ...
                var n, r = t[0], a = t[1];
                return Object.assign({}, e, ((n = {})[r] = "true" === a || "false" !== a && a,
                n))
            }
            ), {
                api_key: ""

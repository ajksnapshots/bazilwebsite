...
(()=>{
    ...
    ;
    var be = (t,e,r)=>(r = t != null ? pe(Ee(t)) : {},
    ye(e || !t || !t.__esModule ? lt(r, "default", {
        value: t,
        enumerable: !0
    }) : r, t));
    var ht = (t,e,r)=>(ge(t, typeof e != "symbol" ? e + "" : e, r),
    r);
    var Xt = Se((Rn,Qt)=>{
        Qt.exports = dr;
        function dr(t, e, r, n) {
    ...
    ;
    function I(t, e, r, n) {
        return t ? (t.addEventListener(e, r, n),
        ()=>t.removeEventListener(e, r, n)) : V
    }
    ...
    var P = (t,e)=>(Array.isArray(e) || (e = [e]),
    e.map(n=>t.dispatchEvent(new Event(n,{
        bubbles: !0
    }))).every(n=>n));
    var {radioInput: he, checkboxOrRadioFocus: Ae, checkboxOrRadioChecked: Ce} = D
      , mt = (t,e=[])=>{
        ...
        if (R(t) && ["checkbox", "radio"].includes(r)) {
            ...
            P(t, ["click", "input", "change"].filter(s=>!e.includes(s))),
            r === "checkbox"))
                return;
        ...
        t.value = "",
        P(t, ["input", "change"].filter(n=>!e.includes(n)))
    }
    ;
    ...
    function vt(t, e, r) {
        ...
        return n.destroy = r || V,
        (o = n.resolve) == null || o.call(n, e),
        e
    }
    var H = (t,e="1",r="iife")=>{
    ...
    var Ut = ({scriptAttributes: t, attributeKey: e, version: r, init: n})=>{
      ...
      , Le = ()=>{
        ...
        return [...document.querySelectorAll(`script ${t}, script ${e}`)].reduce((o,s)=>{
            ...
            return i && !o.includes(i) && o.push(i),
            o
        }
        , [])
    }
    ...
    ;
    var {field: {key: qt}, range: {key: jt}, type: {key: Wt}} = F
      , zt = (t,e)=>{
    ...
    var Et = ({elements: t, values: e},r)=>{
        let n;
        r ? (e.delete(r),
        n = t.filter(o=>o.value === r)) : (e.clear(),
        n = t);
    ...
    ;
    var {field: {key: gr}, reset: {key: Sr}, resetFallback: {key: yr}, range: {key: br}, match: {key: hr}, tagFormat: {key: Ar}, tagCategory: {key: Cr}, hideEmpty: {key: xr, values: _r}, highlight: {key: Fr, values: wr}, highlightCSS: {key: Ir}, activeCSS: {key: Lr}, debouncing: {key: Mr}} = F
      ...
      , ee = (t,e,r,n,o)=>{
        ...
        return t.querySelectorAll(U("field")).forEach((l,a)=>{
            ...
            d.elements.push(v),
            A === "select-one" && M(l, d, v)
        }
        ),
        s
    }
      , Dr = (t,e,r,n,o,s,i)=>{
        let[l,a,m,c,u,p] = [hr, Ar, Lr, Mr, Fr, Ir].map(B=>t.getAttribute(B)), E = L(l, Ot) ? l : void 0, f = L(a, tt) ? a : void 0, T = t.getAttribute(Cr), d = m || n, g = c ? parseFloat(c) : o, A = s || u === wr.true, C = p || i, v = t.getAttribute(br), S, b;
    ...
    ;
    var oe = (t,e,r,n)=>(n && Yt(t),
    r ? !0 : e.every(o=>kr(t, o)))
      , kr = (t,{filterKeys: e, values: r, match: n, mode: o, highlight: s, highlightCSSClass: i, elements: l})=>{
        let a = [...r];
        if (!a.length)
            return !0;
        let m = e.includes("*");
    ...
    ;
    var {field: {key: Br}, range: {key: Nr}, type: {key: Kr}} = F
      , st = class {
        ...
        async handleInputEvents({target: e}) {
            ...
            if (!G(e))
                return;
            let s, i = n.find(({elements: m})=>(s = m.find(c=>c.element === e),
            s));
            if (!i || !s || !M(e, i, s) || o || r)
                return;
            let {debouncing: a} = s;
            this.debouncedApplyFilters || (this.debouncedApplyFilters = (0,
            St.default)(this.applyFilters, a)),
            await this.debouncedApplyFilters()
        }
        async handleSubmit(e) {
            this.allowSubmit || (e.preventDefault(),
        ...
        async toggleFiltersState(e) {
            let {listInstance: r, filtersActive: n} = this
              , o = !e;
            n !== o && (this.filtersActive = o,
            r.initialElement && (await r.displayElement(o ? "initialElement" : "wrapper", !1, !1),
            await r.displayElement(o ? "wrapper" : "initialElement", !0, n !== void 0)))
        }
        async applyFilters(e, r=!0) {
            this.debouncedApplyFilters = void 0;
            let {listInstance: n, filtersData: o, filtersActive: s, highlightResults: i, tagsInstance: l, showQueryParams: a} = this
            ...
            for (let p of m)
                p.valid = oe(p, o, u, i);
            e || (await n.switchPage(1, !1),
            n.scrollToAnchor(),
            a && ie(o),
            await Promise.all([(async()=>{
                u ? (await this.toggleFiltersState(u),
                await n.renderItems(!1, !c)) : (await n.renderItems(!1, !c),
                await this.toggleFiltersState(u))
            }
            )(), (async()=>{
        ...
        storeFiltersData() {
            let {form: e, activeCSSClass: r, debouncing: n, highlightAll: o, highlightCSSClass: s} = this
              , i = ee(e, r, n, o, s);
            return this.filtersData = i,
            this.showFilterResults = i.some(({elements: l})=>l.some(({resultsElement: a})=>a)),
    ...
    var it = class {
        ...
        handleClick(e) {
            ...
            let {hasRemoveTrigger: n, tagsData: o, listInstance: s} = this
              , i = r.closest(U("element", "tagTemplate", {
        ...
        async addTag(e, r) {
            let {wrapper: n, template: o, tagsData: s, globalTagsFormat: i, listInstance: {listAnimation: l}} = this
              , a = ut(o)
              , m = h("tagText", {
                operator: "prefixed",
                scope: a
        ...
        async removeTag(e, r) {
            let {element: n, values: o, filterData: {filterKeys: s}} = e
              , {tagsData: i, filtersInstance: l, listInstance: {listAnimation: a}} = this;
            this.tagsData = i.filter(m=>m !== e),
            await Promise.all([Promise.all(o.map(async m=>{
                if (r)
    ...
    ;
    var {element: {key: ae}, duration: {key: Or}, easing: {key: Pr}, showQuery: {key: $r, values: Hr}, allowSubmit: {key: Vr, values: Gr}, tagFormat: {key: Yr}, highlight: {key: qr, values: jr}, highlightCSS: {key: Wr}, activeCSS: {key: zr}, debouncing: {key: Qr}} = F
      , ce = (t,e)=>{
      ...
      , me = async(t,e)=>{
        ...
        let o = t.getAttribute(Yr)
          , s = L(o, tt) ? o : void 0
          , i = new it(n,e,t,s);
        return await e.addTagsInstance(i),
        i
    }
    ;
    var ue = async()=>{

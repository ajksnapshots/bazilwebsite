...
*/
    ...
    mj.Hh = Number("0") || 0;
    mj.zb = "dataLayer";
    mj.ko = "ChEI8MCzvwYQlIi/k5aw5umRARIkAEX8gnT0sGzkYrbB595zUNNhH7E+7fa6Ef/Ohyeq7+51Kp3aGgKx5A\x3d\x3d";
    var nj = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    function() {
        ...
        (function(b) {
            ...
            var c;
            c = (c = b.vtp_customUrlSource ? b.vtp_customUrlSource : UO("gtm.url", 1)) || TO();
            var d = b[a("vtp_component")];
            if (!d || d == "URL")
                return fk(ik(String(c)));
            var e = ik(String(c)), f;
            if (d === "QUERY")
                a: {
                    ...
                    for (var p = 0; p < n.length; p++) {
                        var q = ck(e, "QUERY", void 0, void 0, n[p]);
                        if (q != void 0 && (!m || q !== "")) {
                            f = q;
                            break a
                        }
                ...
                f = ck(e, d, d == "HOST" ? b[a("vtp_stripWww")] : void 0, d == "PATH" ? b[a("vtp_defaultPages")] : void 0);
            return f
        })
    }();

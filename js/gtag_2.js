    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "function": "__zone",
                "vtp_childContainers": ["list", ["map", "publicId", "G-QLLVGJZX71"]],
...
*/
    ...
    mj.Hh = Number("0") || 0;
    mj.zb = "dataLayer";
    mj.ko = "ChEI8MCzvwYQlIi/k5aw5umRARInAEX8gnSXbsfFyBdInH9bFSawK6vVWHWHt+y4qB4D0Hdi/LTzhmT2GgJlqg\x3d\x3d";
    var nj = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    h.isActive = function(a, b) {
        ...
        if (!c)
            return !0;
        if (!this.isActive([c.Ci], b))
            return !1;
        for (var e = 0; e < c.Nf.length; e++)
            if (this.H[c.Nf[e]].Sd(b))
                return !0;
        return !1
    }
    ;
    ...
    ;
    xE.prototype.Sd = function(a) {
        for (var b = this.C.length - 1; b >= 0; b--)
            if (this.C[b].eventId <= a)
                return this.C[b].Sd;
        return !1
    }
    ;
        ...
        var a = {}
          ...
          , c = function(d) {
            ...
            if (d.vtp_gtmTagId in a)
                sE(a[d.vtp_gtmTagId], d.vtp_gtmEventId, e);
            else if (e) {
                var f = d.vtp_childContainers.map(function(n) {
                  ...
                  , k = {};
                var m = uE(d.vtp_gtmEventId, f, g, k, DA(1, d.vtp_gtmEntityIndex, d.vtp_gtmEntityName), !!d.vtp_inheritParentConfig);
                a[d.vtp_gtmTagId] = m
            }
            C(d.vtp_gtmOnSuccess)
        };
        Z.__zone = c;
        Z.__zone.F = "zone";
